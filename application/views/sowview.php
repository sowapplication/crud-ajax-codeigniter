            ...
            <div class="modal fade" id="Modal_show" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
					<a href="<?php echo site_url('sowmastercontroller/cycleview')?>" class="btn btn-info btn-mg"><span class="glyphicon glyphicon-plus-sign"></span>Add Cycle</a>
                  </div>
                </div>
              </div>
            </div>
